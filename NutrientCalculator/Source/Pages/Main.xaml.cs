...
namespace NutrientCalculator.Source.Pages
{
    ...
    public partial class Main : PhoneApplicationPage
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            CurrentUserProfile.UpdateTime(DateTime.Now);
        ...
        private void UpdateComparisons()
        {
            ...
            {
                calories.Text = "Eat More Calories! (" + Convert.ToString(minDiff.Calories) + "kcal - " + Convert.ToString(maximum.Calories) + "kcal)";
            ...
            {
                protein.Text = "Eat More Protein! (" + Convert.ToString(minDiff.Calories) + "g - " + Convert.ToString(maximum.Protein) + "g)";
            ...
            {
                sugars.Text = "Eat More Sugar! (" + Convert.ToString(minDiff.Sugars) + "g - " + Convert.ToString(maximum.Sugars) + "g)";
            ...
            {
                fat.Text = "Eat More Fat! (" + Convert.ToString(minDiff.Fat) + "g - " + Convert.ToString(maximum.Fat) + "g)";
            ...
            {
                saturates.Text = "Eat More Saturates! (" + Convert.ToString(minDiff.Saturates) + "g - " + Convert.ToString(maximum.Calories) + "g)";
            ...
            {
                fiber.Text = "Eat More Fiber! (" + Convert.ToString(minDiff.Fiber) + "g - " + Convert.ToString(maximum.Fiber) + "g)";
            ...
            {
                salt.Text = "Eat More Salt! (" + Convert.ToString(minDiff.Salt) + "g - " + Convert.ToString(maximum.Salt) + "g)";
        ...
        private void nutrientCalculatorRecipeSearch_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
